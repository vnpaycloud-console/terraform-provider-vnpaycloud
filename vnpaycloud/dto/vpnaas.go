...
// VPNGateway matches the iac-proxy-v2 VPNGateway proto message.
...
// CreateVPNGatewayRequest matches the iac-proxy-v2 CreateVPNGatewayRequest proto message.
...
// UpdateVPNGatewayRequest matches the iac-proxy-v2 UpdateVPNGatewayRequest proto message.
...
// AttachVPCToVPNGatewayRequest matches the iac-proxy-v2 AttachVPCToVPNGatewayRequest proto message.
// project_id and vpn_gateway_id are passed via URL path.
type AttachVPCToVPNGatewayRequest struct {
	VPCID string `json:"vpcId"`
}

// DetachVPCFromVPNGatewayRequest matches the iac-proxy-v2 DetachVPCFromVPNGatewayRequest proto message.
// project_id and vpn_gateway_id are passed via URL path.
type DetachVPCFromVPNGatewayRequest struct {
	VPCID string `json:"vpcId"`
}

// VPNGatewayResponse matches the iac-proxy-v2 VPNGatewayResponse proto message.
type VPNGatewayResponse struct {
	VPNGateway VPNGateway `json:"vpnGateway"`
}

// ListVPNGatewaysResponse matches the iac-proxy-v2 ListVPNGatewaysResponse proto message.
...
// VPNConnection matches the iac-proxy-v2 VPNConnection proto message.
...
// CreateVPNConnectionRequest matches the iac-proxy-v2 CreateVPNConnectionRequest proto message.
// project_id is passed via URL path.
...
// VPNConnectionResponse matches the iac-proxy-v2 VPNConnectionResponse proto message.
type VPNConnectionResponse struct {
	VPNConnection VPNConnection `json:"vpnConnection"`
}

// ListVPNConnectionsResponse matches the iac-proxy-v2 ListVPNConnectionsResponse proto message.
...
// BGPConfig matches the iac-proxy-v2 BGPConfig proto message.
...
// CustomerGateway matches the iac-proxy-v2 CustomerGateway proto message.
...
// CreateCustomerGatewayRequest matches the iac-proxy-v2 CreateCustomerGatewayRequest proto message.
// project_id is passed via URL path.
...
// UpdateCustomerGatewayRequest matches the iac-proxy-v2 UpdateCustomerGatewayRequest proto message.
// project_id and id are passed via URL path.
...
// CustomerGatewayResponse matches the iac-proxy-v2 CustomerGatewayResponse proto message.
type CustomerGatewayResponse struct {
	CustomerGateway CustomerGateway `json:"customerGateway"`
}

// ListCustomerGatewaysResponse matches the iac-proxy-v2 ListCustomerGatewaysResponse proto message.
...
// VPNPublicIP matches the iac-proxy-v2 VPNPublicIP proto message.
...
// CreateVPNPublicIPRequest matches the iac-proxy-v2 CreateVPNPublicIPRequest proto message.
// project_id is passed via URL path.
...
// UpdateVPNPublicIPRequest matches the iac-proxy-v2 UpdateVPNPublicIPRequest proto message.
// project_id and id are passed via URL path.
...
// VPNPublicIPResponse matches the iac-proxy-v2 VPNPublicIPResponse proto message.
type VPNPublicIPResponse struct {
	VPNPublicIP VPNPublicIP `json:"vpnPublicIp"`
}

// ListVPNPublicIPsResponse matches the iac-proxy-v2 ListVPNPublicIPsResponse proto message.
